...
export default function Header() {
    return (
        <header>
            {/*Container*/}
            <div className="px-24 flex justify-between p-5 text-indigo-500 bg-indigo-700">
            {/*Logo*/}
                <a className="font-bold text-5xl text-white p-3 border border-indigo-200 rounded-full bg-indigo-600 cursor-pointer hover:text-indigo-600 hover:bg-white hover:border-indigo-900">Recipes</a>
            {/*Navigation*/}
