...
export const RecipeCard: FC<PostsProps> = ({post}) => {
    ...
    return (
        <div className="group">
            <div className="border-2 bg-white rounded-lg overflow-hidden group-hover:border-indigo-700 cursor-pointer">
                ...
                <div className="p-4">
                    <h2 className="font-bold text-xl text-indigo-500 mb-2 group-hover:underline">{post.title}</h2>
                    <p className="text-indigo-400">{post.body}</p>
                </div>
            </div>
        </div>
    )
